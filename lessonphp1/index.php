 <!-- VARIABLES  -->
<?php
	$pageTitle   = 'АБЗ-4 "КАПОТНЯ" | Главная';
    $pageHeading = 'ОАО АБЗ-4 "КАПОТНЯ"';
	$footerYear = date('Y');
?>
...
-->
	...
	<div id="content">
		...
		<div id="footer">
		      <p>Copyright &copy; <?php echo $footerYear ?>  <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>