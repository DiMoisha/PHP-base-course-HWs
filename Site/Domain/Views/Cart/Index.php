                ...
                $view .= '<tr>
                            ...
                            <td align="left">
                                <form action="/server/cart.php" method="post" role="form">
                                    <input type="hidden" id="Action" name="Action" value="recalc">
                                    <input type="hidden" id="ProductId" name="ProductId" value="'.$item -> productId.'">
                                    <input type="text" name="Quantity" value="'.$item -> quantity.'" placeholder="Укажите количество товара" pattern="\d+(.\d{0,3})?" required="required" size="12" />
